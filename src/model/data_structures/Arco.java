...
public class Arco<K,V> implements Comparable<Arco<K,V>>
{
	...
	public int darNumComparendos()
	{
		return numComparednos;
	}
	
	public void modificarNumComparendos()
	{
		numComparednos = origen.darListaComparenos().size() + destino.darListaComparenos().size();
	}
	...
	{
		return "[IdOrigen: "+origen.darLlave()+", IdDestino: "+destino.darLlave()+"]";
	}
}
